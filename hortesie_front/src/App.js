  ...
  return (
    <div className="App" ref={appRef} >
      ...
      <Routes>
        ...
        <Route path="admin" exact element={<ProtectedPage><AdminAccueil /></ProtectedPage>} />
        <Route path="admin/projets/*" exact element={<ProtectedPage><ListProjectAdmin /></ProtectedPage>} />
        <Route path="admin/tools" exact element={<ProtectedPage><Toolpage /></ProtectedPage>} />
      </Routes>
      </OidcProvider>
